            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="citasTomar">Numero de terapias (hasta nueva valoración)</label>
                                <input type="number" name="citas_a_tomar" class="form-control" id="citasTomar" placeholder="Ingrese el número de terapias a tomar" />
                            </div>
                            @error('telefono')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
